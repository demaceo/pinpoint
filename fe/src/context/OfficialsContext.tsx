...
//     set((state) => ({ officials: [...state.officials, official] })),
//   removeOfficial: (officialId: number) =>
//     set((state) => ({
//       officials: state.officials.filter(
//         (official) => official.id !== officialId
//       ),
//     })),
//   updateOfficial: (officialId: number, updatedOfficial: any) =>
//     set((state) => ({
